      ...
      <div class="col-12 p-0 d-flex align-items-center justify-content-center mt-3 col-sm-12 col-md-12 col-lg-6">
        <div class="col-10">
          <div class="mb-5">
            ...
            Используем ресурсы по-максимуму — только качественная работа и выполнение всех обещаний.
          </div>
          <div class="fs20 fnt-med">Оставить заявку</div>
          <form>
          <div class="">
            <label for="exampleInputEmail1" class="form-label"></label>
            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Имя" aria-describedby="emailHelp">
          </div>
          <div class="mb-3">
